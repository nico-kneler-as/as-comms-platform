...
const SIZE_CONFIG = {
  sm: {
    ...
    iconBox: "mx-auto flex size-12 items-center justify-center",
    iconClass: "size-6 text-slate-400",
    title: "mt-4 text-balance text-sm font-medium text-slate-700",
    description: `mt-1 text-pretty ${TEXT.caption}`,
    actionWrapper: "mt-4 flex justify-center",
  },
  lg: {
    wrapper: "flex h-full flex-col items-center justify-center px-10 text-center",
    iconBox: "flex size-14 items-center justify-center",
    iconClass: "size-7",
    title: "mt-5 text-balance text-base font-semibold text-slate-900",
    description: "mt-1 max-w-sm text-pretty text-sm leading-6 text-slate-500",
