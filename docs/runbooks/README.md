...
| [sms-capture-stopped.md](./sms-capture-stopped.md)               | Inbound SMS missing, or SMS delivery states stop updating              |
...
| [sms-broadcast-send-stuck.md](./sms-broadcast-send-stuck.md) | SMS broadcast run stays `scheduled` / `sending` or queued rows do not advance |
